...
export class EdgeTpuCfgData implements ICfgData {
  ...
  private resolveDuplicated() : void {
    ...
    if(this._edgeTpuConfig["edgetpu-compile"]["intermediate_tensors"] !== undefined) {
      if(this._edgeTpuConfig["edgetpu-compile"]["search_delegate"] !== undefined) {
        ...
        if(this._edgeTpuConfig["edgetpu-compile"]["delegate_search_step"] !== undefined) {
